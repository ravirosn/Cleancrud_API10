...
{
    /// <inheritdoc />
    public partial class AddRoleModuleMenuManagement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                SqlBatch("""
                CREATE OR ALTER PROCEDURE [dbo].[SpRoleModuleMenusGet]
            ...
            migrationBuilder.Sql(
                SqlBatch("""
                CREATE OR ALTER PROCEDURE [dbo].[SpRoleModuleMenuRolesDdl]
                AS
                BEGIN
                    SET NOCOUNT ON;
            ...
            migrationBuilder.Sql(
                SqlBatch("""
                CREATE OR ALTER PROCEDURE [dbo].[SpRoleModuleMenuModulesDdl] @RoleId int
                AS
                BEGIN
                    SET NOCOUNT ON;
            ...
            migrationBuilder.Sql(
                SqlBatch("""
                CREATE OR ALTER PROCEDURE [dbo].[SpRoleModuleMenuMenusDdl]
            ...
            migrationBuilder.Sql(
                SqlBatch("""
                CREATE OR ALTER PROCEDURE [dbo].[SpRoleModuleMenusAdd]
            ...
            migrationBuilder.Sql(
                SqlBatch("""
                CREATE OR ALTER PROCEDURE [dbo].[SpRoleModuleMenusDelete]
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[SpRoleModuleMenusDelete];");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[SpRoleModuleMenusEdit];");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[SpRoleModuleMenusAdd];");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[SpRoleModuleMenuMenusDdl];");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[SpRoleModuleMenuModulesDdl];");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[SpRoleModuleMenuRolesDdl];");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[SpRoleModuleMenusGet];");
