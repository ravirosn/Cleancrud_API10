...
[Migration("20260830110000_AddApplicationModulesGetProcedure")]
public partial class AddApplicationModulesGetProcedure : Migration
{
    ...
    {
        migrationBuilder.Sql("DROP PROCEDURE IF EXISTS [dbo].[SpApplicationModulesGet];");
    }
}
