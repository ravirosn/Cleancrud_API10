...
[Migration("20260901140000_AddOrganizationAdministration")]
public sealed class AddOrganizationAdministration : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        foreach (var procedure in BranchWriteProcedures.Split("-- PROCEDURE BATCH --", StringSplitOptions.RemoveEmptyEntries))
        ...
        foreach (var procedure in DepartmentWriteProcedures.Split("-- PROCEDURE BATCH --", StringSplitOptions.RemoveEmptyEntries))
            migrationBuilder.Sql(procedure);
    }

    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql("DROP PROCEDURE IF EXISTS dbo.SPOrganizationUpd;");
        migrationBuilder.Sql("DROP PROCEDURE IF EXISTS dbo.SPOrganizationGet;");
        // The enhanced branch and department signatures remain backward compatible
        // because all newly introduced parameters have defaults.
    }

    private const string BranchWriteProcedures = """
    ...
    private const string DepartmentWriteProcedures = """
