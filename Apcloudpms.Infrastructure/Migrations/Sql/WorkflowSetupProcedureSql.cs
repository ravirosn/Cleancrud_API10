...
internal static class WorkflowSetupProcedureSql
{
    public static string EditableEditProcedure => Batch(EditProcedure);

    public static string ImmutableEditProcedure => Batch(EditProcedure
        .Replace(
            "IF LEN(@WorkflowCode)<3",
    ...
    private const string EditProcedure = """
    ...
    private static string Batch(string sql) =>
